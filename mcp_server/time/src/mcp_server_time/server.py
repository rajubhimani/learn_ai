...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="MCP Time Server - Time and timezone conversion functionality for MCP"
    )
    parser.add_argument("mode", choices=["stdio"], help="Server mode")
    parser.add_argument(
        "--local-timezone",
        type=str,
        help="Override local timezone",
        default="Asia/Kolkata",
    )  # Default to Asia/Kolkata if not provided
